 // Função para detectar o delimitador (vírgula, ponto-e-vírgula ou tab)
    ...
    // Recupera o conteúdo real do textarea (como está, sem modificações)
    ...
    function calcularRanking() {
      // Recupera o conteúdo dos textareas
    ...
    // Função para resetar os dados e permitir nova edição
    function resetDados() {
    ...
    document.getElementById('resetBtn').addEventListener('click', resetDados);